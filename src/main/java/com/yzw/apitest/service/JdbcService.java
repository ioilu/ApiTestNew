...
import com.yzw.apitest.config.DBConfig;
...
public class JdbcService {
    ...
    private Connection getConnection() throws SQLException {
        String url = dbConfig.getMYSQL_URL();
        String username = dbConfig.getMYSQL_USERNAME();
        String password = dbConfig.getMYSQL_PASSWORD();
